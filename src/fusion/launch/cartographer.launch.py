...
def generate_launch_description():
    ...
    ## if you don't wanna load a prebuilt map erase 1,2,3
    ## For lifelong mapping:1
    # map_path = LaunchConfiguration('map_path',
    #                                 default=os.path.join(turtlebot3_cartographer_prefix ,"config/cheap.pbstream" ) )
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            remappings=[('odom','odom_filtered'),('imu','imu0')],
            parameters=[{'use_sim_time': use_sim_time}],
            arguments=['-configuration_directory', cartographer_config_dir,
                       '-configuration_basename', configuration_basename,   ]),
                       #'-load_state_filename', map_path]), #### For lifelong mapping:3 
